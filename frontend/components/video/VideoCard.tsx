...
export function VideoCard({ video }: VideoCardProps) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl border border-surface-muted bg-white shadow-card transition hover:-translate-y-0.5 hover:shadow-elevated"
    >
